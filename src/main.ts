...
// 资源预加载配置
const preloadLinks = [
  { rel: 'preload', href: '/api/news/v1/list-feed-digest', as: 'fetch', crossorigin: 'anonymous' },
  { rel: 'preload', href: '/api/conflict/v1/list-events', as: 'fetch', crossorigin: 'anonymous' },
  { rel: 'preload', href: '/api/military/v1/list-bases', as: 'fetch', crossorigin: 'anonymous' }
];
